...
function getSnapDateRange(range) {
  ...
  // Snap requires hour-aligned times
  ...
  // Make absolutely sure start is aligned to the top of the hour
  start.setMinutes(0, 0, 0)
